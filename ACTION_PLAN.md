...
| 1.2 | **Character controller**: capsule, walk/run/jump/crouch, slopes, stairs, push objects, ride platforms | The "walk around" | 🔨 walk/slopes/stairs/jump/push/platforms done in `RigidWorld` (tested) and playable in kke_demo; crouch is animation-only so far (capsule resize next) |
