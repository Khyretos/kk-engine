...
| 1.2 | **Character controller**: capsule, walk/run/jump/crouch, slopes, stairs, push objects, ride platforms | The "walk around" | 🔨 walk/slopes/stairs/jump/push/platforms done in `RigidWorld` (tested) and playable in kke_demo; crouch resizes the capsule (`setCharacterHeight`, refuses to stand under a ceiling; tested, and a low roof in kke_demo) ✅ |
