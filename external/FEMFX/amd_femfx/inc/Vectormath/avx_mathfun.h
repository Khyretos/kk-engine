/* Modification to 
   ...
   Added MSVC alignment attribute as in sse_mathfun.h
   Replaced all _mm256_and_si128 with _mm256_and_si256
   Replaced all _mm256_andnot_si128 with _mm256_andnot_si256
   Added static inline to *_ps functions
*/
/* 
