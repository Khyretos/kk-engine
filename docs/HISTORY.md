...
> This is the engine's original README, kept whole as a development log:
> how each system was built, what went wrong, and how it was verified, in
> the order it happened. Mentions of "this README" mean this file. For the
> current state of each system see [ROADMAP.md](../ROADMAP.md), for defects
> [BUGS.md](../BUGS.md), and for getting started the
> [project README](../README.md). Links to the other design notes point at
> their current home in `docs/`.
...
**See `BUILDING.md` for the real, complete setup guide** — exact
...
documented properly in `BUILDING.md`, not just patched quietly.
...
BUILDING.md "Cross-machine build benchmarking" for the full
...
CMake 3.25+ for workflow presets specifically — `BUILDING.md`
